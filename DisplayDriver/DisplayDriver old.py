...
...
....
11/2014: Major bug discovered and solved with Intervals

3/2015: Rendering bug discovered
...
class Graphics(object):
    ...
    def makeColour(self,text):
        ...
        try:
            ...
            print(colours) # Print the colours string was generated
    ...
    def setRes(self,resolution):
        ...
        self.res=resolution
        os.system('mode con:cols=%s lines=%s' %(self.res[0],self.res[1]))
...
class Core(object):
    ...
    def checkSequences(self):
        for sequence in self.sequences:
            ...
            if 'function' in sequenceItem:
                ...
                loopNum=int(sequenceItem['wait']/self.frameLength)
    ...
    def runStartAnimation(self):
        self.addSequence({'name':'Title Sequence',
                          'sequence':[{'function':[self.graphics.displayImage,['Startup Logo',self.testLogo,[7,2]]]},
                                      {'wait':1.5},
                                      {'function':[self.graphics.onscreenText,['Startup credits','By Oliver Bell',[20,40]]]},
                                      {'wait':3},
                                      {'parrallel':[{'function':[self.produceEffect,['Startup Logo',['move','right'],5]]},
                                                    {'function':[self.produceEffect,['Startup credits',['move','left'],5]]}
                                                   ]}
                                      ]})
