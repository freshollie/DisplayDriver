...
class LBlock(Block):
    ...
    def __init__(self,initPos):
        ...
        self.images=[[['\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR],
                     ...
                     [['\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR],
                      ['\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR]
                      ],
                     ...
                     [[DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR],
                      ['\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_GREY\x02\\'+BLOCKCHAR]
                      ]
                     ]
        Block.__init__(self)
...
class LBlockReflected(Block):
    ...
    def __init__(self,initPos):
        ...
        self.images=[[[DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR],
                      ...
                      ['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR]
                      ],
 
                     [['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR],
                      ['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR]
                      ],
 
                     [['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR],
                      ['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR],
                      ['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR]
                      ],
                      
                     [['\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR],
                      [DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_INTENSITY\BACKGROUND_BLUE\x02\\'+BLOCKCHAR]
                      ]
                     ]
        Block.__init__(self)
...
class LineBlock(Block):
    ...
    def __init__(self,initPos):
        self.initPos=initPos[:]
        self.images=[[['\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR]
                      ],
                     ...
                     [['\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_RED\x02\\'+BLOCKCHAR]
                      ],
...
class SBlock(Block):
    ...
    def __init__(self,initPos):
        ...
        self.images=[[['\x01\BACKGROUND_MAGENTA\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR],
                     ...
                     [[DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_MAGENTA\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_MAGENTA\x02\\'+BLOCKCHAR],
                      ['\x01\BACKGROUND_MAGENTA\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_MAGENTA\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR]
                      ],
...
class SBlockReflected(Block):
    ...
    def __init__(self,initPos):
        ...
        self.images=[[[DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_CYAN\x02\\'+BLOCKCHAR],
                     ...
                     [['\x01\BACKGROUND_CYAN\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_CYAN\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR,],
                      [DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_CYAN\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_CYAN\x02\\'+BLOCKCHAR]
                      ],
...
class CrossBlock(Block):
    ...
    def __init__(self,initPos):
        ...
        self.images=[[['\x01\BACKGROUND_YELLOW\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR],
                     ...
                     [[DisplayDriver.BACKGROUNDCHAR,'\x01\BACKGROUND_YELLOW\x02\\'+BLOCKCHAR,DisplayDriver.BACKGROUNDCHAR],
                      ['\x01\BACKGROUND_YELLOW\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_YELLOW\x02\\'+BLOCKCHAR,'\x01\BACKGROUND_YELLOW\x02\\'+BLOCKCHAR]
                      ],
        ...
        for y in range(len(object[0])):
            for x in range(len(object[0][y])):
                ...
                if object[0][y][x]!=DisplayDriver.BACKGROUNDCHAR and realPos[1]+1>=len(self[0]):
                    return True
                elif object[0][y][x]!=DisplayDriver.BACKGROUNDCHAR and self[0][realPos[1]+1][realPos[0]]!=DisplayDriver.BACKGROUNDCHAR:
                    return True
        ...
        for y in range(len(object[0])):
            for x in range(len(object[0][y])):
                ...
                if object.getX()+direction<self.getX() or objectX>=maxRight:
                    ...
                    return False
                elif object[0][y][x]!=DisplayDriver.BACKGROUNDCHAR and self[0][realPos[1]][realPos[0]+direction]!=DisplayDriver.BACKGROUNDCHAR:
                    return False
        return True
...
class ScoreBoard(TextBox):
    ...
    def __init__(self,pos):
        TextBox.__init__(self,pos,[9,6],background=DisplayDriver.BACKGROUNDCHAR)#,chars=[DisplayDriver.BACKGROUNDCHAR,'|','-','_'])
...
class TetrisMenuBackground(object):
    ...
    def genRandomBlock(self):
        self.blocks.append(random.choice(self.blockTypes)([random.randint(0,80),-4]))
...
class HelpScreen(object):
    ...
    def __init__(self):
        self.title=OnscreenText(['#__##__##########___##############'.replace('#',DisplayDriver.BACKGROUNDCHAR),
...
class Tetris(object):
    ...
    def __init__(self,size=[20,20],pos=[0,0]):
        ...
        self.stage=None
        self.border=Border(size,pos=pos[:],chars=['<!','!>','-V','_'],corners=[DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR,DisplayDriver.BACKGROUNDCHAR])
        self.border.render(DisplayDriver.engine)
        
        self.border2=Border([13,5],pos=[pos[0]-13,pos[1]],)
        self.border2.render(DisplayDriver.engine)
        
        self.score=ScoreBoard([pos[0]+size[0],pos[1]])
    ...
    def newBlock(self):
        ...
        if not self.nextBlock:
            ...
            self.nextBlock.setPos([self.pos[0]-8,self.pos[1]+2])
